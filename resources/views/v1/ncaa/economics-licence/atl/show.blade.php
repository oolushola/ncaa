...
@section('main')
    <div class="page-header">
            <button type="button" class="btn btn-gradient-primary btn-icon-text" id="downloadATL" title="Download ATL into EXCEL SHEET">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{URL('economic-licence/atl')}}">ATL</a></li>
            <li class="breadcrumb-item active" aria-current="page">view all air transport licence</li>
            </ol>
        </nav>
    </div>
    <div class="row">
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body" style="padding-left:3px; padding-right:3px;">
                    <h4 class="card-title" style="padding-left:10px; display:inline-block">Air Transport Licence Listings</h4>
                            ...
                            <tbody>
                                ...
                                <?php $counter = 0; ?>
                                    ...
                                    <tr class="{{$css_style}}">
                                        ...
                                        <td>
                                            <a href="{{URL::asset('/confidentials/economic-licence/'.$atl->atl_certificate.'')}}" target="_blank">
                                                {!! $atl->licence_no !!}
                                            </a>
                                        </td>
