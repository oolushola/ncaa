...
@section('title')View all Non Commercial Flights @stop

@section('main')
    <div class="page-header">
            <button type="button" class="btn btn-gradient-primary btn-icon-text" id="downloadPNCF" title="Download pncf into EXCEL SHEET">
                            ...
                            <tbody>
                                ...
                                <?php $counter = 0; ?>
                                    ...
                                    <tr class="{{$css_style}}">
                                        ...
                                        <td>
                                            <a href="{{URL::asset('/confidentials/economic-licence/'.$pncf->pncf_certificate.'')}}" target="_blank">
                                                {!! $pncf->licence_no !!}
                                            </a>
                                        </td>
